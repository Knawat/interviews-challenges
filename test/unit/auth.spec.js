...
describe("Test 'Auth' service", () => {
    ...
    describe("Test 'auth.login' action with credentials", async () => {
        await it('should return Object with userDetails on matching credentials ', () =>
    ...
    describe("Test 'auth.register' action with credentials", async () => {
        await it('should return Object with registration id ', () =>
            expect(broker.call('auth.register', registrationDetails)).resolves.toBeInstanceOf(Object));

        await it('should throw MolecularClient Error on registering through registered email ', () =>
            expect(broker.call('auth.register', rTest1)).rejects.toBeInstanceOf(MoleculerClientError));

        await it('should throw ValidationError Error ', () =>
